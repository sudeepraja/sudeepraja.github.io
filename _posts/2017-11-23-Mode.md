...
If we wanted to do [Pure exploration](https://sudeepraja.github.io/PureExp/), we can modify these algorithms by using the [Top Two Sampling Trick](https://arxiv.org/pdf/1602.08448.pdf). The objective in this case would be to minimize simple/immediate regret.
