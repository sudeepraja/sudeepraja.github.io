...
Choose $$\eta \leq 1/\lambda_1$$. Note that $$A$$ and $$I - \eta A$$ have the same eigenvectors. The eigenvalues corresponding to $$u_1, u_2, \dots ,u_n$$ are $$1-\eta \lambda_1\leq 1-\eta \lambda_2\leq \dots \leq 1-\eta \lambda_n $$. So power iteration on $$I - \eta A$$ will converge to $$u_n$$, which is the minimum eigenvector of $$A$$ and $$x_t^\top A x_t$$ will converge to $$\lambda_n$$.
