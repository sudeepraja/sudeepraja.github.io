...
Let $$f:x\to \mathbb{R}$$ be a function. When there are no restrictions on $$x$$, simple gradient descent can be used to find a minimum of $$f$$. Gradient descent moves in the direction of the negative gradient using step size $$\alpha_k$$.
