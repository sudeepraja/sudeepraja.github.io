...
One could also construct the required tree by sorting the array in $$O(n \log n)$$ and using this [simple recursive algorithm](http://articles.leetcode.com/convert-sorted-array-into-balanced/). This 
