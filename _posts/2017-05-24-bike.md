...
Lets start with the simple case of just 2 researchers who stay at $$X$$ and $$Y$$. The lab is located at $$D$$. Let $$d$$ be the distance metric in this space. ![enter image description here](https://raw.githubusercontent.com/sudeepraja/sudeepraja.github.io/master/images/XYD.png)
...
It makes sense to bike pool only if $$d(X,D) + d(Y,D) > c(X,Y)$$. Although this can be checked using a single if condition, it can also be done by finding the Minimum Weight Perfect Matching (MWPM) of this graph (This will be useful later):
 ![enter image description here](https://raw.githubusercontent.com/sudeepraja/sudeepraja.github.io/master/images/XXYY.png)
...
![enter image description here](https://raw.githubusercontent.com/sudeepraja/sudeepraja.github.io/master/images/2clique.png)
...
The weight of the minimum weight perfect matching is:
$$w(M) = w(A) + w(B) + w(C)$$
...
![enter image description here](https://raw.githubusercontent.com/sudeepraja/sudeepraja.github.io/master/images/intersection.png)
