...
The p-Median problem is NP-hard on general network. Although it can be solved exactly using a Branch and Bound or a Branch and Cut method, this software uses a Tabu search heuristc and provides a good enough sub-optimal solution.  
